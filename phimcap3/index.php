...
function paginates_7() {
    $conn= mysqli_connect("localhost","root","","data_menu");
    $categories= mysqli_query($conn,"SELECT * FROM movies where title like '%học sinh%' or title like '%gia sư%' or title like '%cô giáo%' or title like '%học trò%' or title like '%học%' or title like '%bạn%' ");
...
<head>
    <title>XLXX</title>
    <meta charset="UTF-8">
    <base href="http://localhost/xlxx/phimcap3">
    ...
    <style>
        ...
        .nav-menu .row li.col:nth-of-type(7) {
            color: #ff0000 !important;
        }
        .nav-menu .row li.col:not(:nth-of-type(7)) {
            color: #fff !important;
        }
    ...
    <div class="container-sm h-100 main p-0 bg-dark">
        ...
        <ul class="pagination m-0 position-relative bottom-0 bg-dark">
            <li class="page-item <?php echo (($crpage == 1) ? "disabled not-selected" : "") ?>">
                <a class="page-link" tabindex="-1" href="/xlxx/phimcap3?page=<?php
                                                                            if ($crpage > 1) {
                                                                                echo $crpage - 1;
                                                                            } else {
                                                                                echo 1;
            ...
            ?>
                <li class="page-item <?php echo (($crpage == $i) ? "active" : "") ?>" <?php ?>><a class="page-link" href="/xlxx/phimcap3?page=<?php echo $i ?>"><?php echo $i ?></a></li>
            <?php
            }
            ?>
            <li class="page-item <?php echo (($crpage == $total_page || $crapge== 0) ? "disabled not-selected" : "") ?>"><a tabindex="-1" class="page-link" href="/xlxx/phimcap3?page=<?php echo ($crpage + 1) ?>">Next</a></li>
        </ul>
        <br><br>
        <div class="footer">
            <p>Xlxx &copy; 2021 |</p>
