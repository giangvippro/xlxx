...
<head>
    <title>XLXX</title>
    <meta charset="UTF-8">
    <base href="http://localhost/xlxx/phimsex">
...
<body>
    <div class="container-sm h-100 main p-0 bg-dark">
        ...
        <div class="home py-3 d-flex align-items-center px-3">
            <div>
                <a href="/xlxx/phimsex/">XLXX.COM</a>
            </div>
        </div>
        <!-- Menu categories -->
        <div class="nav-menu">
        ...
        <ul class="pagination m-0 position-relative bottom-0 bg-dark">
            <li class="page-item <?php echo (($crpage == 1) ? "disabled not-selected" : "") ?>">
                <a class="page-link" tabindex="-1" href="/xlxx/phimsex?page=<?php
                                                                            if ($crpage > 1) {
                                                                                echo $crpage - 1;
                                                                            } else {
                                                                                echo 1;
            ...
            ?>
                <li class="page-item <?php echo (($crpage == $i) ? "active" : "") ?>" <?php ?>><a class="page-link" href="/xlxx/phimsex?page=<?php echo $i ?>"><?php echo $i ?></a></li>
            <?php
            }
            ?>
            <li class="page-item <?php echo (($crpage == $total_page) ? "disabled not-selected" : "") ?>"><a tabindex="-1" class="page-link" href="/xlxx/phimsex?page=<?php echo ($crpage + 1) ?>">Next</a></li>
        </ul>
        <br><br>
        <div class="footer">
            <p>Xlxx &copy; 2021 |</p>
            <p>Xlxx.com là web xem <a href="/xlxx/phimsex">phim sex</a> cho người trên 18 tuổi, chỉ có một mục đích đó là giúp bạn giải trí và thỏa mãn sinh lý, nếu bạn dưới 18 tuổi vui lòng quay ra.</p>
